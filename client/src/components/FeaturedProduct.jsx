...
const FeaturedProduct = ({featuredProduct}) => {
    ...
    const isEndDisabled = currentIndex >= featuredProduct.length - itemPerPage;
  return (
    <div>
        <div className="py-12">
            <div className="container mx-auto px-4">
                <h2 className="text-center text-5xl sm:text-6xl font-bold text-emerald-400 mb-4">Sản phẩm mới</h2>
                <div className="relative">
                    <div className="overflow-hidden">
                        <div className="flex transition-transform duration-300 ease-in-out "
                            style={{ transform: `translateX(-${currentIndex * (100 / itemPerPage)}%)` }}    
                        >
