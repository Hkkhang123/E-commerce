		...
		<div className='min-h-screen flex items-center justify-center px-4'>
			...
			>
				<div className='p-6 sm:p-8'>
					...
					<h1 className='text-2xl sm:text-3xl font-bold text-center text-red-500 mb-2'>Đã hủy thanh toán</h1>
					<p className='text-gray-300 text-center mb-6'>
						Đơn hàng của bạn đã hủy
					</p>
					<div className='bg-gray-700 rounded-lg p-4 mb-6'>
						<p className='text-sm text-gray-400 text-center'>
                            Nếu bạn gặp bất kỳ vấn đề nào trong quá trình thanh toán, hãy liên lạc với đội ngũ CSKH của chúng tôi
						</p>
					</div>
